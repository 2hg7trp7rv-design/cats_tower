...
check(plan.scenarioAlgorithmVersion === 'cats-tower-scenario-v2.1.0', 'RUN_PLAN_SCENARIO_ALGORITHM', 'scenarioAlgorithmVersion mismatch');
check(plan.executionVersion === 'cats-tower-step3-executor-v1.0.0', 'RUN_PLAN_EXECUTION_VERSION', 'executionVersion mismatch');
