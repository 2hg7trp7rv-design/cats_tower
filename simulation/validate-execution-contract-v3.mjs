...
const dataPath = resolve(process.argv[2] ?? 'simulation/execution-contract-v3.json');
const schemaPath = resolve('simulation/execution-contract-v3.schema.json');
try {
  ...
  console.log(JSON.stringify({ ok: true, artifactId: 'cats-tower-execution-contract-v3-validator' }));
} catch (error) {
