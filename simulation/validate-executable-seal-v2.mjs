...
if (seal.semanticCommit !== '724d04940f9f3794b993cddbc5af3a7163a0395b') fail('UNEXPECTED_SEMANTIC_COMMIT');
if (seal.semanticTree !== '3552f5820681bd1fe037ac637fafc96b485e35f6') fail('UNEXPECTED_SEMANTIC_TREE');
