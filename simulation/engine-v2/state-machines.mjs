const TRANSITIONS = {
  ...
  'transition.evolution.v2': {
    NOT_ELIGIBLE:['ELIGIBLE'], ELIGIBLE:['QUOTE_ISSUED'], QUOTE_ISSUED:['CONFIRMED','QUOTE_EXPIRED','FAILED'], CONFIRMED:['RUBY_DEBITED','FAILED'], RUBY_DEBITED:['EVOLUTION_GRANTED','FAILED'], EVOLUTION_GRANTED:['RECORDED','FAILED']
  },
  'transition.mastery_exchange.v2': {
    QUOTE_ISSUED:['CONFIRMED','QUOTE_STALE','FAILED'], CONFIRMED:['RESOURCE_DEBITED','QUOTE_STALE','FAILED'], RESOURCE_DEBITED:['MASTERY_APPLIED','CAP_REACHED','FAILED'], MASTERY_APPLIED:['RECORDED','CAP_REACHED'], CAP_REACHED:['OVERFLOW_CREDITED'], OVERFLOW_CREDITED:['RECORDED']
  },
