...
const dataPath = resolve(process.argv[2] ?? 'quality-reviews/step-2-executable-contract-v2/supplement-screen-projection-round-001/qualification-result-v3.json');
const schemaPath = resolve('simulation/result-v3.schema.json');
try {
  ...
  console.log(JSON.stringify({ ok: true, artifactId: 'cats-tower-result-v3-validator' }));
} catch (error) {
