...
async function collectDomInIsolatedWorld(scanAssets, requestAssertions, requestedAssets, allowedPaths, preStabilization, stabilizationSha256) {
    ...
    const offlineHeadRectAfter = localRect(offlineHead);
    const offlineBodyRectAfter = localRect(offlineBody);
    const offlineFooterRectAfter = localRect(offlineFooter);
    if (offlineBody) offlineBody.scrollTop = offlineScrollInitial;
